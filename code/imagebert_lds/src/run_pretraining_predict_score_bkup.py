...
## Required parameters
flags.DEFINE_string("vocab_file", '../bertmodel/vocab.txt',
...
def main(_):
  batch_size = 5
  modelcheckpoint = '../ModelCheckPointGPUSATTLOSS/ImageBertKDD.ckpt-85002'
  ...
  with tf.Session(config=config) as sess:
    ...
    print(sumres)
    assert sumres == 29005
    with open("testBscorebkup.txt",'wb') as file:
